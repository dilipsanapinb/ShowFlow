...
const PaymentModel = () => {
  ...
  // Format the card number input with dashes after every 4 digits
  ...
  // Format the expiry date input with slashes after every 2 digits
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // In a real-world scenario, you would handle payment processing here
    // Simulating a successful payment with a 2-second delay
    setTimeout(() => {
        onOpen(); // Open the modal after successful payment
